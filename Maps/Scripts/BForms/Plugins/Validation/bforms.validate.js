...
(function (factory) {
    if (typeof define === "function" && define.amd) {
        define('bforms-validate', ['jquery'], factory);
    } else {
        factory();
    }
}(function (a) {
        ...
        $.extend($.validator, {
            ...
            prototype: {
                ...
                optional: function (element) {
                    var val = this.elementValue(element);
                    return element.nodeName.toLowerCase() === "select" ? element.getAttribute('data-val-required') == true : !$.validator.methods.required.call(this, val, element) && "dependency-mismatch";
                },
