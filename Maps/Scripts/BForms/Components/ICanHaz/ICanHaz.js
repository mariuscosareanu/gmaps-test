    ...
    var Mustache = function () {
        ...
        */
            render_i18n: function (html, context, partials) {
                ...
                return html.replace(regex, function (match, content) {
                    ...
                    return that.render(that._localeResource(content, translation_mode), context, partials, true);
                });
            },

            _localeResource: function (text) {
                return (this.Resources != null && this.Resources[text] != null) ? this.Resources[text] : text;
            },
        ...
        */
            ...
            setResources: function (resources) {
                Renderer.prototype.Resources = resources;
            }
        });
    }();
    /*!
...
*/
    ...
    (function () {
        ...
        var ich = {
            ...
            setResources: function (ResourceDictionary) {
                Mustache.setResources(ResourceDictionary);
            },
